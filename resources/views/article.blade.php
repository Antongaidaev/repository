...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Редактирование статьи</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Статьи</a></li>
    ...
    <form action="{{ route('articles.update', $article->code) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="product-title-input" value="{{ $article->name }}" placeholder="Введите название статьи"  name="name">
                            <br>
                            <input type="text" class="form-control" id="product-title-input" value="{{ $article->code }}" placeholder="Введите название статьи"  name="code">
                        ...
                        <div>
                            ...
                            <div id="ckeditor-classic">
                                <textarea>{{$article->text}}</textarea>
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                            ...
                            <li class="nav-item"  style="padding: 1em">
                                <a class="nav-linkactive" data-bs-toggle="tab" href="#addproduct-metadata" role="tab">
                                    Мета данные
                                </a>
                            </li>
                        </ul>

...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Редактирование товара {{$product->name}}</li>
                    </ol>
                </div>
    ...
    <form action="{{ route('products.update', $product->code) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="product-title-input" value="{{ $product->name }}" placeholder="Введите название товара"  name="name">
                            <br>
                            <input type="text" class="form-control" id="product-title-input" value="{{ $product->code }}" placeholder="Введите название товара"  name="code">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="text" class="form-control" id="product-price-input" placeholder="Введите цену" aria-label="Цена" aria-describedby="product-price-addon" value="{{ $product->price }}" name="price" >
